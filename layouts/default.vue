<template>
  <div
    ...
    :class="theme"
  >
    <header class="border-t-14 header-color">
      <nav
        ...
        >
          ...
          <li>
            ...
            <nuxt-link
              ...
              to="/#projects"
              v-scroll-to="'/#projects'"
              class="text-copy-primary hover:text-blue-300"
              >Projects</nuxt-link
            >
          </li>
          <li>
    ...
    <footer class="footer-color text-white">
      ...
      >
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a
              href="mailto:akhalid1@gmail.com"
          ...
          <li>
            <a
              href="https://twitter.com/Annna_Zaa"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
          ...
          <li>
            <a
              href="https://instagram.com/anza_gram"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
